...
Address / BBL / BIN
       ...
       ──→ /nyc-due-diligence     → zoning + property + 3D envelope
```
...
| Command | Description |
|---------|-------------|
| `/nyc-due-diligence` | Full site package — zoning analysis + property report + 3D envelope |
...
ln -s $(pwd)/skills-for-architects/00-due-diligence/skills/nyc-landmarks ~/.claude/skills/nyc-landmarks
```
